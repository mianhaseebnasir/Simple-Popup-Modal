...
JavaScript: To handle the open and close functionality.
...
Click the "Open Modal" button to view the popup.
...
script.js - The logic for the modal functions.

👤 Author
Name: Mian Haseeb Nasir
Company : Nova-Stack Technologies
